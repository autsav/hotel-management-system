...
<div class="wrapper d-flex p-2" style="position: relative; ">
    ...
    <div class=" dashboard active " >
            <div class="content-header home-advertisement">
                ...
                <div class="row mb-2" >
                    <div class="col-sm-12" >
                        <img class="w-100 " style="width:50%; height:125px; border-radius:10px;" src="<?php echo base_url() ?>/images/<?php echo $advertisement['image']?>" alt="">
                    </div>
            ...
            <div class="row" style=" width:99%; ">
                <div class="row text-center text-lg-left" >
                    ...
                    <div class="col-lg-4 col-md-4 col-6" style="border-radius: 10px;">
                    <div class="card" >
          ...
          let hotelId = id;
            ...
            $.ajax({
                  ...
                  reviewModal = document.querySelector('.review-modal');
                          ...
                          <div class="col-lg-12 col-md-12 col-12" id="">   
                              <div>
                              <img class="card-img-top img-fluid" style="height: 400px; "  alt="100x100" src="<?php echo base_url(); ?>/images/${hotel['image']}"
                              data-holder-rendered="true">
                              </div>                    
                              <div class="" id="">
                                  <div><h4>${hotel['name']}</h4></div>
